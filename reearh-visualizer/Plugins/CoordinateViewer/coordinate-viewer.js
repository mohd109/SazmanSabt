    ...
    <div id="wrapper">
      <div class="coordinates-container">
        <div class="coordinate-group">
          ...
          <input type="number" id="lat" class="coordinate-value">
        </div>
        
        <div class="coordinate-group">
          <label class="coordinate-label">Longitude (Decimal)</label>
          <input type="number" id="lng" class="coordinate-value">
        </div>
        ...
        <div class="coordinate-group">
          ...
          <input type="number" id="utmx" class="coordinate-value">
        </div>
        
        <div class="coordinate-group">
          <label class="coordinate-label">UTM Northing</label>
          <input type="number" id="utmy" class="coordinate-value">
        </div>
        
        <div class="coordinate-group">
          <label class="coordinate-label">UTM Zone</label>
          <input type="number" id="zone" class="coordinate-value">
        </div>
      </div>
    </div>
